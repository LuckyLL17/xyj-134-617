import type { City, Shelter, EvacuationEdge, EvacuationNode, AppState, Road } from '@/types/index'
...
const rgba = window.DataDisplay.rgba

export function createVehicleParticles(
...
export function drawRoadDensity(
...
export function drawEvacuationFlowArrows(
  ctx: CanvasRenderingContext2D,
  evacuationPlan: EvacuationPlan
): void {
  const cityPlans = evacuationPlan.cityPlans
  ...
  cityPlans.forEach(function (plan: CityPlan): void {
    ...
    plan.path.forEach(function (edge: EvacuationEdge, edgeIdx: number): void {
...
export function startEvacuationAnimation(
  ctx: CanvasRenderingContext2D,
...
export function resetEvacuationAnimation(
  ctx: CanvasRenderingContext2D,
  canvas: HTMLCanvasElement,
  state: AppState,
  evacuationPlan: EvacuationPlan
...
export function drawEvacuationStatic(
  ctx: CanvasRenderingContext2D,
  state: AppState,
  evacuationPlan: EvacuationPlan
): void {
...
export interface EvacuationModule {
  createVehicleParticles: typeof createVehicleParticles
  updateVehicles: typeof updateVehicles
  drawRoadDensity: typeof drawRoadDensity
  drawShelters: typeof drawShelters
  drawVehicles: typeof drawVehicles
  drawEvacuationFlowArrows: typeof drawEvacuationFlowArrows
  drawEvacuationStatic: typeof drawEvacuationStatic
  startEvacuationAnimation: typeof startEvacuationAnimation
  stopEvacuationAnimation: typeof stopEvacuationAnimation
  resetEvacuationAnimation: typeof resetEvacuationAnimation
  isEvacuating: typeof isEvacuating
  setSpeed: typeof setSpeed
  formatNumber: typeof formatNumber
}

const Evacuation: EvacuationModule = {
...
window.Evacuation = Evacuation as unknown as typeof window.Evacuation
